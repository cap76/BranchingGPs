function [Dist Lout] = test_Branching_GP2_test4b(arc);
...
u = log(rand(6,1));
hyp.cov = [-30000;0.5;0.5;-40000;0.5;0.5;u];%[3,0.5,0.5,1,3,0.3,2,2,2]';
hyp.mean = mean(X(:,1));
hyp.lik = log(.2);
...
par1 = {'meanConst','covBranchingRecombinationProcess_v2','likGauss',X,Y};
par2 = {'meanConst','covBranchingRecombinationProcess_v2','likGauss',X,Y,Xstar};
par3 = {'meanConst','covBranchingRecombinationProcess_v2','likGauss',X,Y};
