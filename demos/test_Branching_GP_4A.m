function [Dis, Lout] = test_Branching_GP_4A(seed);
...
hyp.cov = [6;0.5;6;0.5;6;0.5;6;0.5;6;0.5;6;0.5;rand(14,1)];%[3,0.5,0.5,1,3,0.3,2,2,2]';
hyp.mean = mean(X(:,1));
hyp.lik = .1;
...
%subplot(2,4,7); plot([1,2,3,4],[Dis1,Dis2,Dis3,Dis4],'o')
