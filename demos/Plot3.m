...
subplot(2,2,3);plot3(Xin(:,1),Xin(:,2),real(y(2,1:2500))','r.')
hold on
plot3(Xin(:,1),Xin(:,2),real(y(2,2501:end))','b.')
%plot3(Xin(:,1),Xin(:,2),real(y(1,1:10000))','b'),hold on,plot3(Xin(:,1),Xin(:,2),real(y(2,10001:end))','r'),hold on, plot(x,real(y(2,101:200))','r'),set(gca,'XTick',[],'YTick',[])%,plot(x,real(y(2,201:300))','g')
%title('Oscillating function branches from smooth function')
%subplot(2,2,3); imagesc(Kall),set(gca,'XTick',[],'YTick',[])
