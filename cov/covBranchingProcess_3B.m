...
%independently branching from the main branch
...
if nargin<4 %Covariances  
    ...
    if dg    
        ...
        %        K1(ind1,ind2)',K1(ind2,ind2)+K2(ind2,ind2) ,K1(ind2,ind3);
        %        K1(ind1,ind3)',K1(ind2,ind3)',K1(ind3,ind3)+K3(ind3,ind3)];        
        K    = diag(K);
    else        
    if  xeqz   
    K    = covSEiso([hyp(9),hyp(10)],x(:,1));
    ...
    %         K1(ind1,ind3)',K1(ind2,ind3)',K1(ind3,ind3)+K3(ind3,ind3)];
        ...
        K(ind3,ind6) = K(ind3,ind6) + K3;     
         ...
         %    K1(ind2,ind4),K1(ind2,ind5)+K2(ind2,ind5),K1(ind2,ind6);
         %    K1(ind3,ind4),K1(ind3,ind5),K1(ind3,ind6)+K3(ind3,ind6)];
